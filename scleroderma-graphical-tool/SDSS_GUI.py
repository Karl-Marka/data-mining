...
def readFile(filename, colName = "NAME", colName2 = "CLID"):
    ...
    geneList = ["gene1", "gene2", "gene3", "gene4", "gene5", "housekeeping1", "housekeeping2", "housekeeping3", "housekeeping4", "housekeeping5"]
    probeList = ["probe1", "probe2", "probe3", "probe4", "probe5", "probe6", "probe7", "probe8", "probe9", "probe10"]
...
class diseaseScore:
    ...
    def score(self):
        ...
        geneList = ["housekeeping1", "housekeeping2", "housekeeping3", "housekeeping4", "housekeeping5"]
        testedGeneList = ["gene1", "gene2", "gene3", "gene4", "gene5"]
...
class interface:
    ...
    def __init__(self, master):
        ...
        inputfield = LabelFrame(top, width = 285, text = "Patient Data:")
        inputfield.grid(padx=10, pady=5, row = 1, column = 0)
        L1 = Label (inputfield, text="ID:")
