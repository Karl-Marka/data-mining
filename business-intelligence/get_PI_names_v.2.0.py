...
tp = read_csv('merged1985-2016.txt', header=0, sep='\t', iterator=True, chunksize=10000, encoding='cp1252', error_bad_lines=False)
...
uniqueNames.to_csv("PIs_1985-2016.txt", sep = '\t')
